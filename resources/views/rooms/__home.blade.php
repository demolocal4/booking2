                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value="" hidden selected disabled>Select</option> 
                                           ...
                                           <option value="{{ $f->series }}" data-bcode="{{ $f->brCode }}">{{ $f->floor }}</option> 
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @php
                                            ...
                                            $roomstatus = DB::table('roomsstatus')->get();
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @php
                                        	...
                                        	$roomtypes = DB::table('roomtypes')->where('brCode', session()->get('br_code'))->get();	
                                        	}
                                        ...
                                        <select class="form-select" id="roomType" name="roomType" required>
                                         ...
                                         <option value="{{ $roomtype->id }}" data-bcode1="{{ $roomtype->brCode }}">{{ $roomtype->roomType }}</option>
        ...
        <div class="card-body">
            ...
            <table class="table table-striped" id="table1">
                ...
                <tbody id="myBody">
                   ...
                   $rootype = DB::table('roomtypes')->where('id', $list->roomType)->first();
                   ...
                   @endphp
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{$rootype->roomType}}</td>
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value="" hidden selected disabled>Select</option> 
                                           ...
                                           <option value="{{ $f->series }}" data-branch="{{ $f->brCode }}">{{ $f->floor }}</option> 
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="updateroomType" name="updateroomType" required>
                                         ...
                                         <option value="{{ $roomtype->id }}" data-branch1="{{ $roomtype->brCode }}">{{ $roomtype->roomType }}</option>
