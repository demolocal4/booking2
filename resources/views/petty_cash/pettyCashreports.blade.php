    ...
    <div class="card">
        ...
        <div class="card-body" id="print_area">
            ...
            <table style="width: 100%;table-layout:fixed;">
                ...
                <tr>
                    <td></td>
                    <td><h2 style="text-align: center;margin-bottom:20px;">PettyCash Report</h2></td>
                    <td>
            ...
            <div class="table-responsive" id="tbPettyCash">
                                ...
                                $.each(response.data, function(key,val){
                                        ...
                                        $("#PettyCashrpt").append(
                                                        ...
                                                        "<tr>"
                                                            +   
                                                                "<td>"+ val.date +"</td>"+
                                                                "<td class=text-center>"+ val.invNumber +"</td>"+
                                                                "<td>"+ val.vendorName +"</td>"+
                                                                "<td class=text-center>"+ val.cashIn +"</td>"+
                                                                "<td class=text-center>"+ val.cashOut +"</td>"+
                                                                "<td class=text-center><strong>"+ val.Balance +"</strong></td>"
                                                            +
                                                        "</tr>"
