...
@section('page_title', 'Bookings.com Receivable')
...
<section class="section">
    ...
    <div class="card">
        ...
        <form action="{{ url('filter_receivable') }}" id="fmFilter" method="post">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#btn_clear").on("click",function(){
              ...
              window.location.href = '{{ url("receivable") }}';  
        ...
        $(".print").on("click",function(){
            ...
            $('#table1').kinziPrint({
                ...
                header:"<h3>Booking.com Receivable</h3>",
        ...
        $(".export-csv").on("click",function(){
            ...
            $("#table1").table2excel({
                ...
                filename: "{{ date('d-m-Y').uniqid() }}_"+"receivable",
