                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="form-check-input form-check-primary" name="booking_fee" id="booking_fee">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#advance_paid").on("change", function(){
            ...
            let vatAmount = Math.round($("#vat").val() ? $("#vat").val() : 0); //modify at 14-05-2022
            ...
            if($(this).val() == 0) {
                ...
                // $("#balance").val(totalAmount + vatAmount);
                $("#balance").val(booking_fee == true ? totalAmount + vatAmount : totalAmount + 0); //modify at 14-05-2022
        ...
        $("#booking_fee").on("click",function(){
                let totalAmount = parseInt($("#total_amount").val());
                let vatAmount = Math.round($("#vat").val() ? $("#vat").val() : 0);
                let adv = parseInt($("#advance_paid").val() ? $("#advance_paid").val() : 0);

                if($(this).is(':checked')) {
                    booking_fee = true;
                    $("#vat").val(tmpvat);
                    $("#balance").val(totalAmount + tmpvat - adv);
                    // $("#balance").val(totalAmount + vatAmount - adv);
