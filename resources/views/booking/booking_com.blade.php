...
@section('page_title', 'Bookings.com Bookings')
@section('content')
@php
...
<section class="section">
    ...
    <div class="card">
        ...
        <form action="{{ url('filter_booking_com') }}" id="fmFilter" method="post">
            @csrf 
           <div class="row mb-5" style="margin-left: 15px;">
                    ...
                    <select name="filter_field" id="filter_field" class="form-select" required>
                        ...
                        <option value="booking_com_ref" @isset($data) {{ ($data['field_name'] == 'booking_com_ref') ? 'selected' : '' }} @endisset>Booking.com Ref-ID</option>    
                    </select>
                </div>
               <div class="col-md-4">
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody id="bookingBody">
                        ...
                        <tr>
                            ...
                            $duration = DB::table('settings')->where('setting_name', 'booking_com_duration')->first();
                            ...
                            <a href="javascript:void(0)" id="btn_bCancel" 
                            data-v1="{{ $bookings->brCode }}" 
                            data-v2="{{ $bookings->advance_paid }}" 
                            data-id="{{ $bookings->id }}" 
                            data-perday="{{ $bookings->room_tariff }}" 
                            data-booking_com="{{ $bookings->booking_com_ref }}"
                            class="btn btn-outline-danger btn-sm btn_bCancel" data-bs-toggle="modal" data-bs-backdrop="false" data-bs-target="#booking_cancel">Cancel</a>
                            @endif
                            ...
                            <span class="print-ico">
                                ...
                                @endif
                                @if($bookings->checkout_by != 'Checkout' && $bookings->checkout_by != 'Cancelled')
                                <span class="print-ico">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    ...
                                    <div class="form-group">
                                        <input type="number" name="booking_com_ref" min="0" id="booking_com_ref" required class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="col-md-12 col-12">
                                    <label for="perday_tariff">PerDay Tariff</label>
                                    <div class="form-group">
                                        <input type="number" name="perday_tariff" min="0" id="perday_tariff" required class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="col-md-12 col-12">
                                    <label for="paidAmount">Paid Amount</label>
                                    <div class="form-group">
                                        <input type="number" name="paidAmount" min="0" id="paidAmount" required class="form-control" readonly>
                                    </div>
                                </div>
                                <div class="col-md-12 col-12">
...
<script>
    $(document).ready(function(){
        ...
        $("#btn_clear").on("click",function(){
              window.location.href = '{{ url("booking_com") }}';  
        });
        ...
        $("#bookingBody").on("click",".btn_bCancel",function(){
            ...
            let PaidAmount = parseFloat($(this).data('v2')).toFixed(2);
            let perday     = parseFloat($(this).data('perday')).toFixed(2);
            //let advAmount = parseInt($("#advAmt").val());
            $("#booking_com_ref").val($(this).data('booking_com'));
            $("#brcode").val(bCode);
            $("#perday_tariff").val(perday);
            $("#paidAmount").val(PaidAmount);
            $("#refundedAmt").val(PaidAmount - perday);
            $("#remarks").focus();
