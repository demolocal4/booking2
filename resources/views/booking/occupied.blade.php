...
<section class="section">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    ...
                    <?php
                        ...
                        <input type="hidden" name="branch" value="{{ $booking->brCode }}">
 ...
 <input type="text" name="checkindate" id="checkindate" class="form-control" readonly value="{{ $booking->checkin_date }}">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="0" name="advance_paid" id="advance_paid" value="0" step="0.01" class="form-control">
                ...
                <div class="col-md-12 col-12" style="margin-top: 60px;">
                    ...
                    <a href="{{ url('checkout/'.$booking->id) }}" class="btn btn-danger float-end btn_checkout" id="btn_checkout" style="display: none;">Check Out</a>                  
        ...
        <div class="row">
            <div class="col-md-3 col-12">
                <label for="">Booking.com Ref-ID#</label>
                <input type="text" class="form-control" value="{{ $booking->booking_com_ref }}" readonly>
            </div>
        	<div class="col-md-3 col-12">
                    <div class="form-group">
                        <label for="reputation">Reputation</label>
                        <form action="{{ url('checkout/'.$booking->id) }}" method="GET" id="fmReputation">
                        <select name="reputation" id="reputation" class="form-select">
                            <option value="" selected disabled>Select Reputation</option>
                            <option value="1" {{ $booking->reputation == 1 ? 'selected' : '' }}>Good</option>
                            <option value="-1" {{ $booking->reputation == -1 ? 'selected' : '' }}>Bad</option>
                        </select>
                        </form>            
                    </div>
                </div>
                    ...
                    <table class="table table-striped">
                        <tbody id="details-section">
                            <tr>
                                ...
                                <td width="200">
                                    <input type="number" name="amount[]" class="form-control" step="0.01" required placeholder="Amount">
                                </td>
    ...
    $(document).ready(function(){
        ...
        $(".btn_checkout").on("click",function(e){
            ...
            let url = $(this).attr('href');
                ...
                if(confirm('Really you want to Check Out')) {
        ...
        var paidAmt = parseFloat($("#balanceamt").val());
        ...
        $("#advance_paid").on("change", function(){
              ...
              if($(this).val() > paidAmt) {
                if(!alert('Paid Amount Greater than Total Amount')) {
                    $(this).val('').focus();
                    $("#balanceamt").val(parseFloat(paidAmt).toFixed(2));
              ...
              $("#balanceamt").val(parseFloat(paidAmt - paid).toFixed(2));
