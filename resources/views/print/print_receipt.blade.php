    ...
    <div class="card">
        ...
        <div class="card-header">
           ...
           <div class="row" style="padding: 10px 0;">
                ...
                <div class="col-md-1 col-12 col-md-offset-7">
               ...
               <div class="col-md-1 col-12">
                ...
                <div class="col-md-1 col-12">
                    ...
                    <a href="{{ url('contract/'.$receipt->brCode.'/'.$receipt->id) }}" target="_blank" class="btn btn-info" id="contract">Print Contract</a>    
        ...
        <div class="card-body" id="print_area">
           ...
           {{-- TERMS & CONDITIONS --}}
            ...
            <h5 style="margin-left:20px;margin-top:15px;"><strong>TERMS & CONDITIONS:</strong></h5>

            <div style="margin-left:33px;">

                <span style="font-size: 12px; display:inline-block;margin-top:5px;">
