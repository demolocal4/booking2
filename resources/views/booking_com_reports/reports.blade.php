            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3 col-12">
                    ...
                    <div class="form-group">
                        ...
                        <form action="{{ url('bookingComReports') }}" method="GET" id="fmBranch">
        ...
        <div class="card-body" id="print_area">
            ...
            <table style="width: 100%;table-layout:fixed;">
                ...
                <tr>
                    ...
                    <td><h2 style="text-align: center;margin-bottom:20px;">Cash Report (Booking.com)</h2></td>
    ...
    $(document).ready(function(){
        ...
        $("#btn-filter").on("click",function(){
            ...
            if(brcode,fromdate,todate) {
                ...
                $.ajax({
                        url: '{{ url("bookingComReports/ledger") }}',
                        type: 'POST',
        ...
        $(".xlsx").on("click",function(){
            ...
            window.location.href = '{{ url("bookingComReports/export_xlsx") }}'+'/'+id+'/'+fromdate+'/'+todate;
        ...
        $(".mail").on("click",function(){
            ...
            window.location.href = '{{ url("bookingComReports/cash_mail") }}'+'/'+id+'/'+fromdate+'/'+todate+'/'+brname;
