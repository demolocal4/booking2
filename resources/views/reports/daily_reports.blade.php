            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3 col-12">
                    ...
                    <div class="form-group">
                        ...
                        <form action="{{ url('daily_reports') }}" method="GET" id="fmBranch">
                        <select class="form-select elements" id="brCode" name="brCode" required required onchange="document.getElementById('fmBranch').submit();">
        ...
        <div class="card-body" id="print_area">
            ...
            <table style="width: 100%;table-layout:fixed;">
                ...
                <tr>
                    ...
                    <td><h2 style="text-align: center;margin-bottom:20px;">Daily Cash Report</h2></td>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(".xlsx").on("click",function(){
            ...
            window.location.href = '{{ url("daily_report_export") }}'+'/'+id+'/'+fromdate;
        ...
        $(".mail").on("click",function(){
            ...
            window.location.href = '{{ url("daily_report_mail") }}'+'/'+id+'/'+fromdate+'/'+brname;
