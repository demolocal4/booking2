            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3 col-12">
                    ...
                    <div class="form-group">
                        ...
                        <form action="{{ url('reports') }}" method="GET" id="fmBranch">
            ...
            <table style="width: 100%;table-layout:fixed;">
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <p class="landlord_phone"><i class="bi bi-telephone"></i> {{ $branchInfo->landlordPhone ?? $brInfo[0]->landlordPhone }}</p>



                            <p class="landlord_emil"><i class="bi bi-envelope"></i> {{ $branchInfo->landlordEmail ?? $brInfo[0]->landlordEmail }}</p>
                ...
                <tr>
                    ...
                    <td><h2 style="text-align: center;margin-bottom:20px;">Cash Report</h2></td>
