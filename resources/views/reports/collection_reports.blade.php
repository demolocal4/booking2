            ...
            <div class="row mt-3">
                ...
                <div class="col-md-3 col-12">
                    ...
                    <div class="form-group">
                        ...
                        <form action="{{ url('collection_reports') }}" method="GET" id="fmBranch">
        ...
        <div class="card-body" id="print_area">
            ...
            <table style="width: 100%;table-layout:fixed;">
                ...
                <tr>
                    ...
                    <td><h2 style="text-align: center;margin-bottom:20px;">Collection Report</h2></td>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(".xlsx").on("click",function(){
            ...
            window.location.href = '{{ url("collection_export") }}'+'/'+id+'/'+fromdate+'/'+todate;
        });
        $(".mail").on("click",function(){
            ...
            window.location.href = '{{ url("collection_mail") }}'+'/'+id+'/'+fromdate+'/'+todate+'/'+brname;
